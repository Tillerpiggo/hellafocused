...
export function FocusModeSection() {
  return (
    <section className="py-32 bg-gradient-to-b from-background via-blue-50/5 to-background dark:from-background dark:via-blue-950/10 dark:to-background">
      <div className="container max-w-5xl mx-auto px-8">
        {/* Section title */}
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            Use Focus Mode instead.
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            One task. Full screen. Nothing else matters.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {/* Floating badges showing benefits */}
          <div className="absolute -top-8 -right-8 bg-background/90 backdrop-blur-xl rounded-2xl px-4 py-2 shadow-lg border border-border/50 hidden lg:block">
            <span className="text-sm font-medium text-primary">Zero distractions</span>
          </div>
          
          <div className="absolute -bottom-8 -left-8 bg-background/90 backdrop-blur-xl rounded-2xl px-4 py-2 shadow-lg border border-border/50 hidden lg:block">
            <span className="text-sm font-medium text-green-600 dark:text-green-400">Start working instantly</span>
          </div>
          
          <div className="absolute top-1/2 -right-12 bg-background/90 backdrop-blur-xl rounded-2xl px-4 py-2 shadow-lg border border-border/50 hidden xl:block">
            <span className="text-sm font-medium text-purple-600 dark:text-purple-400">Feel accomplished</span>
          </div>
        </div>
